# PoC — autolabel bootstrap

Detect vehicles on top-down drone video. Class spec: **[README.md](README.md)**. Manual-label rounds: **[EVALUATION.md](EVALUATION.md)**.

This doc is the **autolabel path**: preprocess → YOLO-World boxes → train YOLO11s → eval on autolabel GT.
...
**Autolabel** (training boxes) follows the README table: truck/bus stay keep.
...
**Next:** manual-label evaluation (CVAT GT, pack ablations, experiment rounds) → **[EVALUATION.md](EVALUATION.md)**.